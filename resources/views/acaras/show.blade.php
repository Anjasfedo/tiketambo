...
@section('content')
    <div class="container mx-auto py-8">
        ...
        <div class="mt-8">
            ...
            <a href="{{ route('tikets.create', $acara->id) }}"
                ...
                <tbody>
                    @foreach ($acara->tiket as $tiket)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 border-b">
                                <a href="{{ route('tikets.show', [$acara->id, $tiket->id]) }}"
                                    class="text-blue-500 hover:underline">Lihat</a>
                                <a href="{{ route('tikets.edit', [$acara->id, $tiket->id]) }}"
                                    class="ml-2 text-yellow-500 hover:underline">Edit</a>
                                <form action="{{ route('tikets.destroy', [$acara->id, $tiket->id]) }}" method="POST"
