...
@section('content')
    <section class="min-h-screen flex flex-col px-4">
        <div class="flex flex-col flex-1 max-w-[1200px] mx-auto w-full">
            ...
            <div class="py-8">
                <h1 class="text-3xl font-bold text-center text-indigo-600 mb-6">Pesan Tiket: {{ $userTiket->tiket->nama }}
                </h1>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <ul class="text-gray-700 space-y-2">
                            <li><strong>Nama Acara:</strong> {{ $userTiket->tiket->acara->nama }}</li>
                            <li><strong>Lokasi:</strong> {{ $userTiket->tiket->acara->lokasi }}</li>
                            <li><strong>Tanggal:</strong> {{ $userTiket->tiket->acara->tanggal }}</li>
                            <li><strong>Jam:</strong> {{ $userTiket->tiket->acara->waktu }}</li>
                        </ul>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form action="{{ route('penjualan.resale', $userTiket->id) }}" method="POST">
                            @csrf
